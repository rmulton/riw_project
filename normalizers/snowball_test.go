...
var testParagraphs = []testParagraph{
	testParagraph{
		"horse  tree accordingly HoRse 36-BiT   64_for robin.com er#3 lala/lala lala\\lala ro@la.com ...",
		[]string{"accordingly"},
		[]string{"hors", "tree", "hors", "36-bit", "64_for", "robin.com", "er#3", "lala", "lala", "lala", "lala", "ro@la.com"},
	},
}
