...
func NewOnDiskFiller(bufferSize int, folder string, readingChannel chan *readers.Document, routines int, parentWaitGroup *sync.WaitGroup) *OnDiskFiller {
...
func (filler *OnDiskFiller) readDocs() {
...
func (filler *OnDiskFiller) finish() {
	filler.index.writeAllPostingLists()
...
func (filler *OnDiskFiller) toTfIdf() {
...
func (filler *OnDiskFiller) addDoc(doc *readers.Document) {
...
func (filler *OnDiskFiller) writePostingLists() {
	defer filler.waitGroup.Done()
